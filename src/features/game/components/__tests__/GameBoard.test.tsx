...
describe("GameBoard Component", () => {
  ...
  describe("Layout and Responsive Design", () => {
    ...
    it("should center tableau with max width constraint", () => {
      ...
      const tableauContainer =
        screen.getByTestId("game-tableau").parentElement?.parentElement;
  ...
  describe("Stock and Waste Interactions", () => {
    it("should call onStockClick when stock is clicked", () => {
      ...
      render(
        <GameBoard gameState={mockGameState} onStockClick={onStockClick} />
      );
    ...
    it("should call onWasteClick when waste area is clicked", () => {
      ...
      render(
        <GameBoard gameState={mockGameState} onWasteClick={onWasteClick} />
      );
  ...
  describe("Custom Props", () => {
    ...
    it("should accept custom data-testid", () => {
      render(
        <GameBoard gameState={mockGameState} data-testid="custom-board" />
      );
