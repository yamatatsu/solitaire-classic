...
import type { Card, GameState, MoveAction, Rank, Suit } from "../index";
import {
  isCard,
  isGameState,
  isMoveAction,
  ...
  describe("Validation Functions", () => {
    ...
    describe("isValidCard", () => {
      ...
      it("should return false for invalid card objects", () => {
        ...
        expect(isValidCard({ suit: "hearts", rank: 1, faceUp: true })).toBe(
          false
        );
  ...
  describe("Validation with Error Messages", () => {
    describe("validateCard", () => {
      ...
      it("should handle null and undefined inputs", () => {
        ...
        expect(validateCard(undefined).errors).toContain(
