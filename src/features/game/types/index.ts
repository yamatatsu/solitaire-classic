...
export const MOVE_TYPES: readonly MoveAction['type'][] = ['MOVE_CARD', 'FLIP_CARD', 'DEAL_CARD', 'RESET_STOCK'] as const;
...
export const isGameState = (value: unknown): value is GameState => {
  ...
  return Array.isArray(obj.tableau) &&
